...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed bottom-36 z-[100] flex w-full max-w-[320px] translate-x-9 flex-col-reverse',
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  ...
  border border-slate-200 p-4 pr-8 shadow-lg transition-all 
  ...
  data-[state=open]:sm:slide-in-from-bottom-full dark:border-slate-800`,
  {
    variants: {
      variant: {
        default:
